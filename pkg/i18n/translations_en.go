...
For more details, use each command without arguments to see its usage.`,
	...
	"expense_add_cuotas_usage":    "❌ Usage: `/add_cuotas <total_amount> <description> <installments> [category] [payment_method] [spender] [date]`\n\nExamples:\n`/add_cuotas 120000 Phone 12 visa 2025-01-10`\n`/add_cuotas 30000 Shoes 3 ropa mastercard user2 2024-12-15`\n\nCreates N monthly expenses tied together (cuotas).",
	"expense_invalid_installments": "❌ Invalid installments. Please provide a number >= 2.",
	"expense_cuotas_added":        "✅ Installments created!\n\nTotal: %s\nDescription: %s\nInstallments: %d\nPurchase date: %s\nFirst installment ID: %d\n",
